function [Yap1pw, Sln1pw, Msnpw, Targets] = ...
    knockout2(Yap1pw, Sln1pw, Msnpw, Targets, knockouts)
...
%arguments:
%   1.-4. pathway tables to be changed (Enzymes, PKApw, Snf1pw, TORpw, Enzymes, Targets)
%   5. knockouts = cell of strings with components that should be knocked
%   out
